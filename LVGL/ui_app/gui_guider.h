...
typedef struct
{
	...
	lv_obj_t *Hot_Board_label_decimal;
	lv_obj_t *Hot_Board_label_point;
	lv_obj_t *Hot_Board_label_Integer;
	lv_obj_t *Hot_Board_label_symbol;
	...
	lv_obj_t *screen_1;
	bool screen_1_del;
	lv_obj_t *screen_1_btn_enter;
	lv_obj_t *screen_1_btn_enter_label;
	lv_obj_t *screen_1_spinbox_1;
	lv_obj_t *screen_1_spinbox_1_btn_plus;
	lv_obj_t *screen_1_spinbox_1_btn_minus;
	lv_obj_t *screen_1_sw_start;
	lv_obj_t *screen_1_label_C;
	lv_obj_t *screen_1_label_setv_value;
	lv_obj_t *screen_1_label_temp;
	lv_obj_t *screen_1_led_fan;
	lv_obj_t *screen_1_led_tr;
	lv_obj_t *screen_1_led_sw;
	lv_obj_t *screen_1_label_A;
	lv_obj_t *screen_1_label_CR;
	lv_obj_t *screen_1_label_V;
	lv_obj_t *screen_1_label_VL;
	lv_obj_t *screen_1_digital_clock_1;
	lv_obj_t *screen_1_btn_ext;
	lv_obj_t *screen_1_btn_ext_label;
