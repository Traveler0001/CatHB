...
void start_digital_clock_1_timer(lv_timer_t *timer)
{
    clock_count(&start_digital_clock_1_hour_value, &start_digital_clock_1_min_value, &start_digital_clock_1_sec_value);
    if (lv_obj_is_valid(guider_ui.start_digital_clock_1))
    {
