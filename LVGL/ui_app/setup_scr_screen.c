...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_digital_clock_1, 95, 223);
    lv_obj_set_size(ui->screen_digital_clock_1, 130, 16);
    lv_label_set_text(ui->screen_digital_clock_1, "0:00:00");
    ...
    lv_obj_set_pos(ui->screen_label_1, 50, 104);
    lv_obj_set_size(ui->screen_label_1, 220, 50);
    lv_label_set_text(ui->screen_label_1, "000.000");
    ...
    lv_obj_set_pos(ui->screen_label_2, 282, 104);
    lv_obj_set_size(ui->screen_label_2, 33, 50);
